...
# CONFIGURATION
# =============================================================================
LLM_RESULTS_DIR = "chatgpt/results_ZS_R/answers"
ORIGINAL_RESULTS_DIR = "original_queries/answers"
OUTPUT_TXT_FILE = "chatgpt/results_ZS_R/evaluation_results.txt"
OUTPUT_CSV_FILE = "chatgpt/results_ZS_R/evaluation_results.csv"
# =============================================================================
...
def parse_table_output(content):
    ...
    Improved version that handles PostgreSQL-style table output better.
    """
...
def compare_dataframes(df1, df2, tolerance=1e-6):
    ...
    Only checks if both DataFrames contain the same data.
    Returns (are_equal, differences)
    """
    ...
    if df1.shape != df2.shape:
        ...
        # Don't return immediately - still try to compare data
    """
...
def evaluate_results(llm_dir, original_dir, output_txt_file, output_csv_file):
    ...
    for original_file in original_files:
        ...
        # Compare
        are_equal, differences = compare_dataframes(df_original, df_llm)
